    ...
    <Container component="main" maxWidth="sm" className={classes.root}>
      ...
      <main>
        <Typography component="div" variant="body1">
          ...
          <p>
            Your nomination for a digital public good has been submitted
            successfully. We will review your submission promptly, and we will
            be in contact with any follow up questions as needed.
          </p>

          <p>
            You can track the progress of your nomination through&nbsp;
            <a
              href={`https://github.com/${GITHUB_OWNER}/${GITHUB_REPO}/pull/${router.query.pr}`}
              target="_blank"
              rel="noreferrer"
            >
              this pull request
